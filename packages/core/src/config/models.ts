...
export function getEffectiveModel(
  ...
  // DeepSeek models don't have fallback logic
...
/**
 * Checks if a model name is a DeepSeek model.
 */
export function isDeepSeekModel(model: string): boolean {
  return model.startsWith('deepseek-') || model === 'deepseek-chat' || model === 'deepseek-coder';
}
